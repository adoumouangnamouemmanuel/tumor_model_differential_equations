...
import { SideNav } from "@/components/code-explanation/side-nav"
...
f = @(t, y) [ 
    ...
    sigma - delta*y(3) + (rho*y(1)*y(3))/(m + y(1)) + (rho1*y(2)*y(3))/(m1 + y(2)) - mu*y(1)*y(3) - mu1*y(2)*y(3) 
                        ...
                        >
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <EquationCard title="Normal Cells" equation="\frac{dN}{dt} = rN(1 - \beta_1 N) - \eta NI - \gamma NT" />
                                <EquationCard
                                    title="Tumor Cells"
...
[t3, Y3] = ode15s(f, tspan, Y0);`}
                    ...
                    <section id="figure-reproduction">
                        <CodeCard
